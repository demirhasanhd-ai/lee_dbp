...
const sourceFiles = new Map([
  ...
  ["./bedenTezsizCoursePackages", path.join(rootDir, "lib", "data", "bedenTezsizCoursePackages.ts")],
  ["./bedenTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "bedenTezsizCommonCoursePackages.ts")],
  ...
  ["./biyolojiTezsizCoursePackages", path.join(rootDir, "lib", "data", "biyolojiTezsizCoursePackages.ts")],
  ["./biyolojiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "biyolojiTezsizCommonCoursePackages.ts")],
  ["./ekonomiFinansTezsizCoursePackages", path.join(rootDir, "lib", "data", "ekonomiFinansTezsizCoursePackages.ts")],
  ["./ekonomiFinansTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "ekonomiFinansTezsizCommonCoursePackages.ts")],
  ...
  ["./enerjiSistemleriTezsizCoursePackages", path.join(rootDir, "lib", "data", "enerjiSistemleriTezsizCoursePackages.ts")],
  ["./enerjiSistemleriTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "enerjiSistemleriTezsizCommonCoursePackages.ts")],
  ...
  ["./gastronomiTezsizCoursePackages", path.join(rootDir, "lib", "data", "gastronomiTezsizCoursePackages.ts")],
  ["./gastronomiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "gastronomiTezsizCommonCoursePackages.ts")],
  ...
  ["./gidaTeknolojisiTezsizCoursePackages", path.join(rootDir, "lib", "data", "gidaTeknolojisiTezsizCoursePackages.ts")],
  ["./gidaTeknolojisiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "gidaTeknolojisiTezsizCommonCoursePackages.ts")],
  ...
  ["./muhasebeFinansmanTezsizCoursePackages", path.join(rootDir, "lib", "data", "muhasebeFinansmanTezsizCoursePackages.ts")],
  ["./muhasebeFinansmanTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "muhasebeFinansmanTezsizCommonCoursePackages.ts")],
  ["./muhendislikTeknolojiYonetimiTezsizCoursePackages", path.join(rootDir, "lib", "data", "muhendislikTeknolojiYonetimiTezsizCoursePackages.ts")],
  ["./muhendislikTeknolojiYonetimiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "muhendislikTeknolojiYonetimiTezsizCommonCoursePackages.ts")],
  ...
  ["./organikTarimIsletmeciligiTezsizCoursePackages", path.join(rootDir, "lib", "data", "organikTarimIsletmeciligiTezsizCoursePackages.ts")],
  ["./organikTarimIsletmeciligiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "organikTarimIsletmeciligiTezsizCommonCoursePackages.ts")],
  ["./resimTezsizCoursePackages", path.join(rootDir, "lib", "data", "resimTezsizCoursePackages.ts")],
  ["./resimTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "resimTezsizCommonCoursePackages.ts")],
  ...
  ["./siyasetKamuYonetimiTezsizCoursePackages", path.join(rootDir, "lib", "data", "siyasetKamuYonetimiTezsizCoursePackages.ts")],
  ["./siyasetKamuYonetimiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "siyasetKamuYonetimiTezsizCommonCoursePackages.ts")],
  ...
  ["./tarihTezsizCoursePackages", path.join(rootDir, "lib", "data", "tarihTezsizCoursePackages.ts")],
  ["./tarihTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "tarihTezsizCommonCoursePackages.ts")],
  ["./turkDiliEdebiyatiTezsizCoursePackages", path.join(rootDir, "lib", "data", "turkDiliEdebiyatiTezsizCoursePackages.ts")],
  ["./turkDiliEdebiyatiTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "turkDiliEdebiyatiTezsizCommonCoursePackages.ts")],
  ...
  ["./ybsTezsizCoursePackages", path.join(rootDir, "lib", "data", "ybsTezsizCoursePackages.ts")],
  ["./ybsTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "ybsTezsizCommonCoursePackages.ts")],
  ["./yonetimOrganizasyonTezsizCoursePackages", path.join(rootDir, "lib", "data", "yonetimOrganizasyonTezsizCoursePackages.ts")],
  ["./yonetimOrganizasyonTezsizCommonCoursePackages", path.join(rootDir, "lib", "data", "yonetimOrganizasyonTezsizCommonCoursePackages.ts")],
