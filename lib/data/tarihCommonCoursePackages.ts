...
export const tarihCommonCoursePackages: CoursePackage[] = [
  {
    "code": "DAN8XX",
    "name": "DANIŞMANLIK",
    "theory": 0,
    ...
    "purpose": "Danışmanlık kapsamında tarih alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    ...
    "resources": "Güncel tarih literatürü; arşiv, kütüphane ve dijital tarih kaynakları; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
      "4",
      "10",
      "16"
    ...
    "outcomes": [
      ...
      "İleri tarih araştırmaları yaklaşımlarını karşılaştırır.",
      "Danışmanlık kapsamında uygun tarih araştırma yöntemini uygular.",
      "Danışmanlık bulgularını tarihsel ve toplumsal bağlamıyla değerlendirir.",
      "Danışmanlık alanındaki kanıtlara dayalı tarihsel argüman geliştirir."
    ],
    "weeklyTopics": [
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Öğrencinin Danışmanı",
    "purpose": "Uzmanlık alan dersi kapsamında tarih alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Tarih alanına özgü ileri literatür, birincil ve ikincil kaynaklar, araştırma problemi, historiografik çerçeve, kaynak tenkidi, tarihsel yorum, bilimsel yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel tarih literatürü; arşiv, kütüphane ve dijital tarih kaynakları; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "İleri tarih araştırmaları yaklaşımlarını karşılaştırır.",
      "Uzmanlık alan dersi kapsamında uygun tarih araştırma yöntemini uygular.",
      "Uzmanlık alan dersi bulgularını tarihsel ve toplumsal bağlamıyla değerlendirir.",
      "Uzmanlık alan dersi alanındaki kanıtlara dayalı tarihsel argüman geliştirir."
    ],
    "weeklyTopics": [
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Öğrencinin Danışmanı",
    "purpose": "Seminer kapsamında tarih alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Tarih alanına özgü ileri literatür, birincil ve ikincil kaynaklar, araştırma problemi, historiografik çerçeve, kaynak tenkidi, tarihsel yorum, bilimsel yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel tarih literatürü; arşiv, kütüphane ve dijital tarih kaynakları; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "İleri tarih araştırmaları yaklaşımlarını karşılaştırır.",
      "Seminer kapsamında uygun tarih araştırma yöntemini uygular.",
      "Seminer bulgularını tarihsel ve toplumsal bağlamıyla değerlendirir.",
      "Seminer alanındaki kanıtlara dayalı tarihsel argüman geliştirir."
    ],
    "weeklyTopics": [
  ...
  },
  {
    ...
    "purpose": "Bilimsel araştırma ve yayın etiği kapsamında tarih alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Tarih alanına özgü ileri literatür, birincil ve ikincil kaynaklar, araştırma problemi, historiografik çerçeve, kaynak tenkidi, tarihsel yorum, bilimsel yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel tarih literatürü; arşiv, kütüphane ve dijital tarih kaynakları; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "Tarih araştırma yöntemleri yaklaşımlarını karşılaştırır.",
      "Bilimsel araştırma ve yayın etiği kapsamında uygun tarih araştırma yöntemini uygular.",
      "Bilimsel araştırma ve yayın etiği bulgularını tarihsel ve toplumsal bağlamıyla değerlendirir.",
      "Bilimsel araştırma ve yayın etiği alanındaki kanıtlara dayalı tarihsel argüman geliştirir."
    ],
    "weeklyTopics": [
      ...
      "Veri analizi",
      "Bilimsel raporlama",
      "Tarih araştırma yöntemleri alanında kuramsal yaklaşımların karşılaştırılması",
      "Bilimsel araştırma ve yayın etiği kapsamında veri ve kanıtların değerlendirilmesi",
      "Bilimsel araştırma ve yayın etiği alanında tarihsel yorumların karşılaştırılması",
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Öğrencinin Danışmanı",
    "purpose": "Tez çalışması kapsamında tarih alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Tarih alanına özgü ileri literatür, birincil ve ikincil kaynaklar, araştırma problemi, historiografik çerçeve, kaynak tenkidi, tarihsel yorum, bilimsel yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel tarih literatürü; arşiv, kütüphane ve dijital tarih kaynakları; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "İleri tarih araştırmaları yaklaşımlarını karşılaştırır.",
      "Tez çalışması kapsamında uygun tarih araştırma yöntemini uygular.",
      "Tez çalışması bulgularını tarihsel ve toplumsal bağlamıyla değerlendirir.",
      "Tez çalışması alanındaki kanıtlara dayalı tarihsel argüman geliştirir."
    ],
    "weeklyTopics": [
