...
export const temelIslamBilimleriCommonCoursePackages: CoursePackage[] = [
  {
    "code": "DAN8XX",
    "name": "DANIŞMANLIK",
    "theory": 0,
    ...
    "purpose": "Danışmanlık kapsamında Temel İslam Bilimleri alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    ...
    "resources": "Güncel Temel İslam Bilimleri literatürü; yazma eser, kütüphane ve dijital kaynaklar; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
      "4",
      "16"
    ],
    "outcomes": [
      ...
      "Temel İslam Bilimleri yaklaşımlarını karşılaştırır.",
      "Danışmanlık kapsamında uygun temel_islam_bilimleri araştırma yöntemini uygular.",
      "Danışmanlık bulgularını temel_islam_bilimlerisel ve toplumsal bağlamıyla değerlendirir.",
      "Danışmanlık alanındaki kanıtlara dayalı temel_islam_bilimlerisel argüman geliştirir."
    ],
    "weeklyTopics": [
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Öğrencinin Danışmanı",
    "purpose": "Uzmanlık alan dersi kapsamında Temel İslam Bilimleri alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Temel İslam Bilimleri alanına özgü ileri literatür, klasik ve çağdaş kaynaklar, araştırma problemi, metin çözümleme, tarihsel bağlamlandırma, bilimsel yorum, akademik yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel Temel İslam Bilimleri literatürü; yazma eser, kütüphane ve dijital kaynaklar; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "Temel İslam Bilimleri yaklaşımlarını karşılaştırır.",
      "Uzmanlık alan dersi kapsamında uygun temel_islam_bilimleri araştırma yöntemini uygular.",
      "Uzmanlık alan dersi bulgularını temel_islam_bilimlerisel ve toplumsal bağlamıyla değerlendirir.",
      "Uzmanlık alan dersi alanındaki kanıtlara dayalı temel_islam_bilimlerisel argüman geliştirir."
    ],
    "weeklyTopics": [
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Öğrencinin Danışmanı",
    "purpose": "Seminer kapsamında Temel İslam Bilimleri alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Temel İslam Bilimleri alanına özgü ileri literatür, klasik ve çağdaş kaynaklar, araştırma problemi, metin çözümleme, tarihsel bağlamlandırma, bilimsel yorum, akademik yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel Temel İslam Bilimleri literatürü; yazma eser, kütüphane ve dijital kaynaklar; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "Temel İslam Bilimleri yaklaşımlarını karşılaştırır.",
      "Seminer kapsamında uygun temel_islam_bilimleri araştırma yöntemini uygular.",
      "Seminer bulgularını temel_islam_bilimlerisel ve toplumsal bağlamıyla değerlendirir.",
      "Seminer alanındaki kanıtlara dayalı temel_islam_bilimlerisel argüman geliştirir."
    ],
    "weeklyTopics": [
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Doç. Dr. RIDVAN YARBA",
    "purpose": "Bilimsel araştırma yöntemleri ve yayın etiği kapsamında Temel İslam Bilimleri alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Temel İslam Bilimleri alanına özgü ileri literatür, klasik ve çağdaş kaynaklar, araştırma problemi, metin çözümleme, tarihsel bağlamlandırma, bilimsel yorum, akademik yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel Temel İslam Bilimleri literatürü; yazma eser, kütüphane ve dijital kaynaklar; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "Bilimsel araştırma ve etik yaklaşımlarını karşılaştırır.",
      "Bilimsel araştırma yöntemleri ve yayın etiği kapsamında uygun temel_islam_bilimleri araştırma yöntemini uygular.",
      "Bilimsel araştırma yöntemleri ve yayın etiği bulgularını temel_islam_bilimlerisel ve toplumsal bağlamıyla değerlendirir.",
      "Bilimsel araştırma yöntemleri ve yayın etiği alanındaki kanıtlara dayalı temel_islam_bilimlerisel argüman geliştirir."
    ],
    "weeklyTopics": [
      ...
      "Yayın etiği",
      "Bilimsel raporlama",
      "Bilimsel araştırma ve etik alanında kuramsal yaklaşımların karşılaştırılması",
      "Bilimsel araştırma yöntemleri ve yayın etiği kapsamında veri ve kanıtların değerlendirilmesi",
      "Bilimsel araştırma yöntemleri ve yayın etiği alanında temel_islam_bilimlerisel yorumların karşılaştırılması",
  ...
  },
  {
    ...
    "prerequisites": "Yok",
    "instructor": "Öğrencinin Danışmanı",
    "purpose": "Tez çalışması kapsamında Temel İslam Bilimleri alanındaki bilimsel gelişimi, kaynak çözümleme yetkinliğini ve akademik etik farkındalığını geliştirmek.",
    "content": "Temel İslam Bilimleri alanına özgü ileri literatür, klasik ve çağdaş kaynaklar, araştırma problemi, metin çözümleme, tarihsel bağlamlandırma, bilimsel yorum, akademik yazım ve araştırma etiği süreçleri.",
    "methods": "Literatür incelemesi, akademik tartışma, bireysel araştırma ve danışmanlık görüşmesi.",
    "resources": "Güncel Temel İslam Bilimleri literatürü; yazma eser, kütüphane ve dijital kaynaklar; bilimsel araştırma ve yayın etiği rehberleri.",
    "sdgs": [
    ...
    "outcomes": [
      ...
      "Temel İslam Bilimleri yaklaşımlarını karşılaştırır.",
      "Tez çalışması kapsamında uygun temel_islam_bilimleri araştırma yöntemini uygular.",
      "Tez çalışması bulgularını temel_islam_bilimlerisel ve toplumsal bağlamıyla değerlendirir.",
      "Tez çalışması alanındaki kanıtlara dayalı temel_islam_bilimlerisel argüman geliştirir."
    ],
    "weeklyTopics": [
