...
export const isletmeTezsizCommonCoursePackages: CoursePackage[] = [
  {
    "code": "ISL7XX",
    "aliases": [
      "ISL701",
    ...
    "purpose": "Öğrencinin işletme alanındaki mesleki bir problemi bilimsel kaynaklara dayalı olarak çözümlemesini, uygulanabilir bir proje yaklaşımı geliştirmesini ve çalışmasını etik ilkelere uygun biçimde raporlamasını sağlamak.",
    ...
    "resources": "Proje konusuna özgü güncel hakemli literatür; Enstitü yazım ve etik yönergeleri; ilgili mevzuat, standart ve mesleki raporlar.",
    "sdgs": [
      "4",
      "8",
      "9"
    ...
    "outcomes": [
      "İşletme alanındaki mesleki bir problemi yapılandırır.",
      "Proje problemine uygun bilimsel kaynakları eleştirel değerlendirir.",
      "Uygulanabilir bir proje yöntemi ve çalışma planı geliştirir.",
      "Proje bulgularını yönetsel ve sürdürülebilirlik ölçütleriyle yorumlar.",
      "Bitirme projesini bilimsel ve etik ilkelere uygun raporlar."
    ],
    "weeklyTopics": [
      "Proje alanının ve beklentilerin belirlenmesi",
      "Proje probleminin sınırlandırılması",
      "Amaç, kapsam ve çalışma sorularının yapılandırılması",
      "Kaynak tarama stratejisinin oluşturulması",
      "Bilimsel ve mesleki kaynakların değerlendirilmesi",
      "Proje yönteminin seçilmesi",
      ...
      "Bulguların işletme açısından yorumlanması",
      "Yönetsel, etik ve sürdürülebilirlik etkilerinin değerlendirilmesi",
      "Proje raporunun yapılandırılması",
      "Bilimsel yazım ve etik uygunluk denetimi",
    ...
    "workloads": [
      ...
      {
        "name": "Kaynak İnceleme ve Proje Çalışması",
        "count": 15,
        "hours": 44,
        "total": 660
      },
      {
        "name": "Proje Raporunun Hazırlanması",
        "count": 1,
        "hours": 180,
        "total": 180
      },
    ...
    "qualityChecks": [
      ...
      },
      {
        ...
        "status": "Doğrulanmalı",
        "note": "Resmî müfredat kimliği korunmuş; ayrıntılı OBS bağlantısı doğrulanamadığından eksik akademik alanlar handoff ölçütleri ve programın mevcut 11 program çıktısı temelinde öneri niteliğinde tamamlanmıştır."
      },
      {
