...
export function PublicSiteHeader({ active = "home", bibliometricsSource }: { active?: "home" | "catalog" | "quality" | "thesisSdg" | "bibliometrics"; bibliometricsSource?: "scopus" | "trdizin" | "doctorate" }) {
  return (
