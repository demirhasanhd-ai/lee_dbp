import { BarChart3, Bell, CircleHelp, House, LibraryBig, PieChart, ScatterChart } from "lucide-react";
import { ThemeToggle } from "./ThemeToggle";
import { dbpPath } from "../lib/dbpPath";
import { eEnstituUrl } from "../lib/eEnstituUrl";

export function PublicSiteHeader({ active = "home" }: { active?: "home" | "catalog" | "quality" | "thesisSdg" | "bibliometrics" }) {
  return (
      ...
      <div className="navigation-bar">
        <div className="header-container navigation-inner">
          ...
          <nav aria-label="Ana menü">
            ...
            <a className={active === "bibliometrics" ? "active" : undefined} href={dbpPath("/article")}><ScatterChart size={18} />Bibliyometrik Göstergeler</a>
